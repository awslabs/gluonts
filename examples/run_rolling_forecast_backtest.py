...
from gluonts.evaluation.backtest import make_evaluation_predictions, generate_rolling_datasets
...
def generate_datasets():
    ...
    print("start: {}\nt0: {}\nt1: {}\nt_end: {}".format(t_index, t0_index, t1_index, t_end_index))
...
if __name__ == "__main__":
    ...
    forecast_it, ts_it = make_evaluation_predictions(
        dataset.test, predictor=predictor, num_samples=100, rolling_time_range=(t0,t1)
    )
