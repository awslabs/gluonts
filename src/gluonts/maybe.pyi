...
def map_or_else(val: Optional[T], fn: Callable[[T], U], factory: Callable[[], U]) -> U: ...
...
def or_else(val: Optional[T], factory: Callable[[], Optional[T]]) -> Optional[T]: ...
...
class Maybe:
    ...
    def map_or_else(self, fn: Callable[[T], U], factory: Callable[[], U]) -> U: ...
    def unwrap(self) -> T: ...
