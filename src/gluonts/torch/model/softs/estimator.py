...
class SofTSEstimator(PyTorchLightningEstimator):
    ...
    and wraps it into a ``SofTSLightningModule`` for training
    ...
    def _create_instance_splitter(
        self, module: SofTSLightningModule, mode: str
    ):
    ...
    def create_validation_data_loader(
        self, data: Dataset, module: SofTSLightningModule, **kwargs
    ) -> Iterable:
