...
from gluonts.torch.model.deepvar.estimator import DeepVAREstimator
...
from gluonts.torch.model.mqf2.module import MQF2MultiItemModel
from gluonts.torch.model.mqf2.lightning_module import (
    MQF2MultiItemLightningModule,
)
...
class MQF2MultiItemEstimator(DeepVAREstimator):
    r"""
    Estimator class for the model MQF2 proposed in the paper
    ``Multivariate Quantile Function Forecaster``
    by Kan, Aubet, Januschowski, Park, Benidis, Ruthotto, Gasthaus
    This is the multi-item (multivariate across time series) variant of MQF2

    This class is based on
    gluonts.torch.model.deepar.estimator.DeepVAREstimator
    Parameters
    ----------
    freq
    ...
    def create_lightning_module(self) -> MQF2MultiItemLightningModule:
        model = MQF2MultiItemModel(
            freq=self.freq,
        ...
        return MQF2MultiItemLightningModule(model=model, loss=self.loss)
