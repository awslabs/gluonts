...
def get_general_parser():
    ...
    if 'SM_MODEL_DIR' in os.environ:
        ...
        parser.add_argument('--model_dir', type=PosixPath,
                            default=os.environ['SM_MODEL_DIR'])  # To store the trained model
        parser.add_argument('--log_dir', type=PosixPath,
                            default=os.environ['SM_OUTPUT_DATA_DIR'])  # To store tensorboard log
    else:
    ...
    parser.add_argument('--injection_method', type=str, choices=['None', 'local_outliers'], default='local_outliers')
    ...
    parser.add_argument('--train_split_method', type=str,
    ...
    parser.add_argument('--rate_true_anomalies', type=float, default=0.0,
