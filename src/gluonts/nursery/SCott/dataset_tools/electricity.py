...
def group_electricity_cv(num_ts=10, num_groups=14, context_length=72, prediction_length=12, file_name='default'):
...
def group_electricity_mb(num_ts=10, num_groups=14, context_length=72, prediction_length=12, file_name='default'):
