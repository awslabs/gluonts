...
def group_traffic_cv(num_ts=10, num_groups=14, context_length=72, prediction_length=12, file_name='default'):
...
def group_traffic_mb(num_ts=10, num_groups=14, context_length=72, prediction_length=12, file_name='default'):
    dataset = get_dataset("traffic")
    len_sample = context_length + prediction_length
    dataset_group = [[] for i in range(num_groups)]
    train_full_data = []
