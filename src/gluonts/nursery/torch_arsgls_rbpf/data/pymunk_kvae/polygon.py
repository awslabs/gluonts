...
class BallBox:
    ...
    def run(self, iterations=20, sequences=500, angle_limits=(0, 360),
            ...
            radius=3,
            flip_gravity=None, save=None, filepath='/tmp/data/polygon.npz',
            delay=None, shape=1):
        if save:
        ...
        for i in range(len(points) - 1):
            self.static_lines.append(
                pymunk.Segment(self.space.static_body, points[i], points[i + 1],
                               0.0))
