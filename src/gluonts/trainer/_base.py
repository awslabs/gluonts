...
class Trainer:
    ...
    def __init__(
        ...
        patience: int = 10,
        minimum_learning_rate: Optional[float] = None,
        ...
        if minimum_learning_rate is None:
            minimum_learning_rate = learning_rate * 0.001
        ...
        assert (
            minimum_learning_rate is None or 0 <= minimum_learning_rate
        ...
        self.lrs = lrs.MetricAttentiveScheduler(
    ...
    def count_model_params(self, net: nn.HybridBlock) -> int:
        ...
        return sum(np.prod(params[param].shape) for param in params)
        ...
        with tempfile.TemporaryDirectory(
            ...
            with HybridContext(
                ...
                for epoch_no in range(self.epochs):
                    ...
                    self.lrs.step(loss_value(epoch_loss))
