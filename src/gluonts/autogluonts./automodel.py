...
class AutoEstimator:
    def __init__(self,model,dictionary_of_hyperparameters,dataset):
        '''
    ...
    def train(self):
        ...
        def train_finetune(args, reporter):
            ...
            for epoch in range(args.epochs):
                ...
                mse = newloop(epoch,new_estimator,new_net,trainer,inputs)
                print('MSE:', mse)
                #self.record[args] = net.collect_params()._params
                reporter(epoch = epoch+1, accuracy = 1/mse)
