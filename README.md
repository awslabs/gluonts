...
N-BEATS                          | Global       | Univariate               | MLP, residual links | [MXNet](https://github.com/awslabs/gluon-ts/blob/dev/src/gluonts/model/n_beats/_estimator.py) | [paper](https://openreview.net/forum?id=r1ecqn4YwB)
