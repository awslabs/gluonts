...
def test_metric_shape(metric, axis: Optional[tuple]):
    input_length = 20
    label_length = 5
    num_entries = 7
...
@pytest.mark.parametrize("axis", [None, (0, 1), (0,), (1,), ()])
def test_metric_inf(metric, axis: Optional[tuple]):
...
@pytest.mark.parametrize("axis", [None, (0, 1), (0,), (1,), ()])
def test_metric_nan(metric, axis: Optional[tuple]):
    time_series_length = 3
    number_of_entries = 2
